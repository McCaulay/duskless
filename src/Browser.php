...
class Browser
{
     ...
     *
     * @var \McCaulay\Duskless\ElementResolver
     */
    public $resolver;
     ...
     * @param  \McCaulay\Duskless\ElementResolver  $resolver
     * @return void
     */
     ...
     * @return string
     */
    public function screenshot(bool $full = false)
    {
     ...
     * @return $this
     */
    public function storeScreenshot(string $name, bool $full = false)
    {
